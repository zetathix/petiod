...
graph TD
    ...
    Domain --> Clade1["Clade 1: PetIOD
    (Animistic Pets / OwnSec Safe Harbor)"]
    Domain --> Clade2["Clade 2: Comdatum
    (Data Companions / Chatbots / LLMs)"]
    Domain --> Clade3["Clade 3: Organum
    (Tools / Assistants / Smart Hubs)"]
    
    Clade1 --> Pet1["Local Minimal Animism
    (Non-semantic accumulators, Umbra projection, I_e = 0)"]
    Clade2 --> NonPet1["Conversational & Relational Partners
    (Evaluated on dialogue memory & social depth)"]
    Clade3 --> NonPet2["Utilitarian Platforms
    (Evaluated on task accuracy & performance)"]
